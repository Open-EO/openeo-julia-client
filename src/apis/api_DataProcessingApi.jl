...
struct DataProcessingApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `DataProcessingApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ DataProcessingApi }) = "https://openeo.example/api/v1"

const _returntypes_compute_result_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_compute_result(_api::DataProcessingApi, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_compute_result_DataProcessingApi, "/result", ["Bearer", ], request_body)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Process and download data synchronously
...
"""
function compute_result(_api::DataProcessingApi, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = _oacinternal_compute_result(_api, request_body; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function compute_result(_api::DataProcessingApi, response_stream::Channel, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = _oacinternal_compute_result(_api, request_body; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_create_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("201", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_create_job(_api::DataProcessingApi, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_create_job_DataProcessingApi, "/jobs", ["Bearer", ], request_body)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end
...
Return: Nothing, OpenAPI.Clients.ApiResponse
"""
function create_job(_api::DataProcessingApi, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = _oacinternal_create_job(_api, request_body; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function create_job(_api::DataProcessingApi, response_stream::Channel, request_body::Dict{String, Any}; _mediaType=nothing)
    _ctx = _oacinternal_create_job(_api, request_body; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_debug_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => LogEntries,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_debug_job(_api::DataProcessingApi, job_id::String; offset=nothing, level=nothing, limit=nothing, _mediaType=nothing)

    OpenAPI.validate_param("limit", "debug_job", :minimum, limit, 1, false)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_debug_job_DataProcessingApi, "/jobs/{job_id}/logs", ["Bearer", ])
...
"""
function debug_job(_api::DataProcessingApi, job_id::String; offset=nothing, level=nothing, limit=nothing, _mediaType=nothing)
    _ctx = _oacinternal_debug_job(_api, job_id; offset=offset, level=level, limit=limit, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function debug_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; offset=nothing, level=nothing, limit=nothing, _mediaType=nothing)
    _ctx = _oacinternal_debug_job(_api, job_id; offset=offset, level=level, limit=limit, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("204", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_delete_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_job_DataProcessingApi, "/jobs/{job_id}", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
Return: Nothing, OpenAPI.Clients.ApiResponse
"""
function delete_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_delete_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_delete_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_describe_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DescribeJob200Response,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_describe_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_describe_job_DataProcessingApi, "/jobs/{job_id}", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
"""
function describe_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_describe_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function describe_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_describe_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_estimate_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => BatchJobEstimate,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_estimate_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_estimate_job_DataProcessingApi, "/jobs/{job_id}/estimate", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
"""
function estimate_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_estimate_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function estimate_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_estimate_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_list_file_types_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => FileFormats,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_list_file_types(_api::DataProcessingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_list_file_types_DataProcessingApi, "/file_formats", ["Bearer", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end
...
"""
function list_file_types(_api::DataProcessingApi; _mediaType=nothing)
    _ctx = _oacinternal_list_file_types(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function list_file_types(_api::DataProcessingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_list_file_types(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_list_jobs_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => BatchJobs,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_list_jobs(_api::DataProcessingApi; limit=nothing, _mediaType=nothing)
    OpenAPI.validate_param("limit", "list_jobs", :minimum, limit, 1, false)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_list_jobs_DataProcessingApi, "/jobs", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.query, "limit", limit)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
"""
function list_jobs(_api::DataProcessingApi; limit=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_jobs(_api; limit=limit, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function list_jobs(_api::DataProcessingApi, response_stream::Channel; limit=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_jobs(_api; limit=limit, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_list_results_DataProcessingApi = Dict{Regex,Type}(
...
function _oacinternal_list_results(_api::DataProcessingApi, job_id::String; partial=nothing, _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_list_results_DataProcessingApi, "/jobs/{job_id}/results", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
...
"""
function list_results(_api::DataProcessingApi, job_id::String; partial=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_results(_api, job_id; partial=partial, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function list_results(_api::DataProcessingApi, response_stream::Channel, job_id::String; partial=nothing, _mediaType=nothing)
    _ctx = _oacinternal_list_results(_api, job_id; partial=partial, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_start_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("202", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_start_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_start_job_DataProcessingApi, "/jobs/{job_id}/results", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
Return: Nothing, OpenAPI.Clients.ApiResponse
"""
function start_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_start_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function start_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_start_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_stop_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("204", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_stop_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_stop_job_DataProcessingApi, "/jobs/{job_id}/results", ["Bearer", ])
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
Return: Nothing, OpenAPI.Clients.ApiResponse
"""
function stop_job(_api::DataProcessingApi, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_stop_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function stop_job(_api::DataProcessingApi, response_stream::Channel, job_id::String; _mediaType=nothing)
    _ctx = _oacinternal_stop_job(_api, job_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_job_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("204", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_update_job(_api::DataProcessingApi, job_id::String, update_batch_job_request::UpdateBatchJobRequest; _mediaType=nothing)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "PATCH", _returntypes_update_job_DataProcessingApi, "/jobs/{job_id}", ["Bearer", ], update_batch_job_request)
    OpenAPI.Clients.set_param(_ctx.path, "job_id", job_id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
...
Return: Nothing, OpenAPI.Clients.ApiResponse
"""
function update_job(_api::DataProcessingApi, job_id::String, update_batch_job_request::UpdateBatchJobRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_job(_api, job_id, update_batch_job_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_job(_api::DataProcessingApi, response_stream::Channel, job_id::String, update_batch_job_request::UpdateBatchJobRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_job(_api, job_id, update_batch_job_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_validate_custom_process_DataProcessingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ValidationResult,
    Regex("^" * replace("4XX", "x"=>".") * "\$") => Error,
    Regex("^" * replace("5XX", "x"=>".") * "\$") => Error,
)

function _oacinternal_validate_custom_process(_api::DataProcessingApi, process_graph_with_metadata::ProcessGraphWithMetadata; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_validate_custom_process_DataProcessingApi, "/validation", ["Bearer", ], process_graph_with_metadata)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end
...
"""
function validate_custom_process(_api::DataProcessingApi, process_graph_with_metadata::ProcessGraphWithMetadata; _mediaType=nothing)
    _ctx = _oacinternal_validate_custom_process(_api, process_graph_with_metadata; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function validate_custom_process(_api::DataProcessingApi, response_stream::Channel, process_graph_with_metadata::ProcessGraphWithMetadata; _mediaType=nothing)
    _ctx = _oacinternal_validate_custom_process(_api, process_graph_with_metadata; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
