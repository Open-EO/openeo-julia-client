...
"""
Base.@kwdef mutable struct Process <: OpenAPI.APIModel
    ...
    function Process(id, summary, description, categories, parameters, returns, deprecated, experimental, exceptions, examples, links, process_graph, )
        OpenAPI.validate_property(Process, Symbol("id"), id)
        OpenAPI.validate_property(Process, Symbol("summary"), summary)
        OpenAPI.validate_property(Process, Symbol("description"), description)
        OpenAPI.validate_property(Process, Symbol("categories"), categories)
        OpenAPI.validate_property(Process, Symbol("parameters"), parameters)
        OpenAPI.validate_property(Process, Symbol("returns"), returns)
        OpenAPI.validate_property(Process, Symbol("deprecated"), deprecated)
        OpenAPI.validate_property(Process, Symbol("experimental"), experimental)
        OpenAPI.validate_property(Process, Symbol("exceptions"), exceptions)
        OpenAPI.validate_property(Process, Symbol("examples"), examples)
        OpenAPI.validate_property(Process, Symbol("links"), links)
        OpenAPI.validate_property(Process, Symbol("process_graph"), process_graph)
...
const _property_types_Process = Dict{Symbol,String}(Symbol("id")=>"String", Symbol("summary")=>"String", Symbol("description")=>"String", Symbol("categories")=>"Vector{String}", Symbol("parameters")=>"Vector{ProcessParameter}", Symbol("returns")=>"ProcessReturnValue", Symbol("deprecated")=>"Bool", Symbol("experimental")=>"Bool", Symbol("exceptions")=>"Dict{String, ProcessExceptions}", Symbol("examples")=>"Vector{ProcessExample}", Symbol("links")=>"Vector{Link}", Symbol("process_graph")=>"Dict{String, ProcessGraph}", )
OpenAPI.property_type(::Type{ Process }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_Process[name]))}

function check_required(o::Process)
    true
end

function OpenAPI.validate_property(::Type{ Process }, name::Symbol, val)
    if name === Symbol("id")
        OpenAPI.validate_param(name, "Process", :pattern, val, r"^\w+$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "Process", :format, val, "commonmark")
    end
end
