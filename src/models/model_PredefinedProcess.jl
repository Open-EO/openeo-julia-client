...
"""
Base.@kwdef mutable struct PredefinedProcess <: OpenAPI.APIModel
    ...
    function PredefinedProcess(id, summary, description, categories, parameters, returns, deprecated, experimental, exceptions, examples, links, process_graph, )
        OpenAPI.validate_property(PredefinedProcess, Symbol("id"), id)
        OpenAPI.validate_property(PredefinedProcess, Symbol("summary"), summary)
        OpenAPI.validate_property(PredefinedProcess, Symbol("description"), description)
        OpenAPI.validate_property(PredefinedProcess, Symbol("categories"), categories)
        OpenAPI.validate_property(PredefinedProcess, Symbol("parameters"), parameters)
        OpenAPI.validate_property(PredefinedProcess, Symbol("returns"), returns)
        OpenAPI.validate_property(PredefinedProcess, Symbol("deprecated"), deprecated)
        OpenAPI.validate_property(PredefinedProcess, Symbol("experimental"), experimental)
        OpenAPI.validate_property(PredefinedProcess, Symbol("exceptions"), exceptions)
        OpenAPI.validate_property(PredefinedProcess, Symbol("examples"), examples)
        OpenAPI.validate_property(PredefinedProcess, Symbol("links"), links)
        OpenAPI.validate_property(PredefinedProcess, Symbol("process_graph"), process_graph)
...
function OpenAPI.validate_property(::Type{ PredefinedProcess }, name::Symbol, val)
    if name === Symbol("id")
        OpenAPI.validate_param(name, "PredefinedProcess", :pattern, val, r"^\w+$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "PredefinedProcess", :format, val, "commonmark")
    end
end
