...
@doc raw"""Batch_Job_Results_Response_as_STAC_Collection
...
"""
Base.@kwdef mutable struct BatchJobResultsResponseAsSTACCollection <: OpenAPI.APIModel
    ...
    function BatchJobResultsResponseAsSTACCollection(var"openeo:status", stac_version, stac_extensions, type, id, title, description, keywords, version, deprecated, license, providers, extent, links, var"cube:dimensions", summaries, assets, )
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("openeo:status"), var"openeo:status")
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("stac_version"), stac_version)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("stac_extensions"), stac_extensions)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("type"), type)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("id"), id)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("title"), title)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("description"), description)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("keywords"), keywords)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("version"), version)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("deprecated"), deprecated)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("license"), license)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("providers"), providers)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("extent"), extent)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("links"), links)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("cube:dimensions"), var"cube:dimensions")
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("summaries"), summaries)
        OpenAPI.validate_property(BatchJobResultsResponseAsSTACCollection, Symbol("assets"), assets)
        return new(var"openeo:status", stac_version, stac_extensions, type, id, title, description, keywords, version, deprecated, license, providers, extent, links, var"cube:dimensions", summaries, assets, )
    end
end # type BatchJobResultsResponseAsSTACCollection

const _property_types_BatchJobResultsResponseAsSTACCollection = Dict{Symbol,String}(Symbol("openeo:status")=>"ResultStatus", Symbol("stac_version")=>"String", Symbol("stac_extensions")=>"Vector{StacExtensionsInner}", Symbol("type")=>"String", Symbol("id")=>"String", Symbol("title")=>"String", Symbol("description")=>"String", Symbol("keywords")=>"Vector{String}", Symbol("version")=>"String", Symbol("deprecated")=>"Bool", Symbol("license")=>"String", Symbol("providers")=>"Vector{Provider}", Symbol("extent")=>"CollectionExtent", Symbol("links")=>"Vector{Link}", Symbol("cube:dimensions")=>"Dict{String, STACCollectionCubeDimensions}", Symbol("summaries")=>"Dict{String, STACSummariesCollectionProperties}", Symbol("assets")=>"Dict{String, Asset}", )
OpenAPI.property_type(::Type{ BatchJobResultsResponseAsSTACCollection }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_BatchJobResultsResponseAsSTACCollection[name]))}

function check_required(o::BatchJobResultsResponseAsSTACCollection)
...
function OpenAPI.validate_property(::Type{ BatchJobResultsResponseAsSTACCollection }, name::Symbol, val)
    if name === Symbol("stac_version")
        OpenAPI.validate_param(name, "BatchJobResultsResponseAsSTACCollection", :pattern, val, r"^(0\.9.\d+|1\.\d+.\d+)")
    end
    if name === Symbol("stac_extensions")
        OpenAPI.validate_param(name, "BatchJobResultsResponseAsSTACCollection", :uniqueItems, val, true)
    end
    if name === Symbol("type")
        OpenAPI.validate_param(name, "BatchJobResultsResponseAsSTACCollection", :enum, val, ["Collection"])
    end
    if name === Symbol("id")
        OpenAPI.validate_param(name, "BatchJobResultsResponseAsSTACCollection", :pattern, val, r"^[\w\-\.~\/]+$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "BatchJobResultsResponseAsSTACCollection", :format, val, "commonmark")
    end
end
