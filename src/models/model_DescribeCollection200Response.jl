...
@doc raw"""describe_collection_200_response

    DescribeCollection200Response(;
...
"""
Base.@kwdef mutable struct DescribeCollection200Response <: OpenAPI.APIModel
    ...
    function DescribeCollection200Response(stac_version, stac_extensions, type, id, title, description, keywords, version, deprecated, license, providers, extent, links, var"cube:dimensions", summaries, assets, )
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("stac_version"), stac_version)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("stac_extensions"), stac_extensions)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("type"), type)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("id"), id)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("title"), title)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("description"), description)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("keywords"), keywords)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("version"), version)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("deprecated"), deprecated)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("license"), license)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("providers"), providers)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("extent"), extent)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("links"), links)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("cube:dimensions"), var"cube:dimensions")
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("summaries"), summaries)
        OpenAPI.validate_property(DescribeCollection200Response, Symbol("assets"), assets)
...
function check_required(o::DescribeCollection200Response)
    ...
    o.var"cube:dimensions" === nothing && (return false)
    o.summaries === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ DescribeCollection200Response }, name::Symbol, val)
    if name === Symbol("stac_version")
        OpenAPI.validate_param(name, "DescribeCollection200Response", :pattern, val, r"^(0\.9.\d+|1\.\d+.\d+)")
    end
    if name === Symbol("stac_extensions")
        OpenAPI.validate_param(name, "DescribeCollection200Response", :uniqueItems, val, true)
    end
    if name === Symbol("type")
        OpenAPI.validate_param(name, "DescribeCollection200Response", :enum, val, ["Collection"])
    end
    if name === Symbol("id")
        OpenAPI.validate_param(name, "DescribeCollection200Response", :pattern, val, r"^[\w\-\.~\/]+$")
    end
    if name === Symbol("description")
        OpenAPI.validate_param(name, "DescribeCollection200Response", :format, val, "commonmark")
    end
end
