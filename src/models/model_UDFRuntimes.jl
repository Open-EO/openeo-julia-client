...
"""
Base.@kwdef mutable struct UDFRuntimes <: OpenAPI.APIModel
    ...
    function UDFRuntimes(title, description, type, default, deprecated, experimental, links, )
        OpenAPI.validate_property(UDFRuntimes, Symbol("title"), title)
        OpenAPI.validate_property(UDFRuntimes, Symbol("description"), description)
        OpenAPI.validate_property(UDFRuntimes, Symbol("type"), type)
        OpenAPI.validate_property(UDFRuntimes, Symbol("default"), default)
        OpenAPI.validate_property(UDFRuntimes, Symbol("deprecated"), deprecated)
        OpenAPI.validate_property(UDFRuntimes, Symbol("experimental"), experimental)
        OpenAPI.validate_property(UDFRuntimes, Symbol("links"), links)
        return new(title, description, type, default, deprecated, experimental, links, )
    end
end # type UDFRuntimes

const _property_types_UDFRuntimes = Dict{Symbol,String}(Symbol("title")=>"String", Symbol("description")=>"String", Symbol("type")=>"String", Symbol("default")=>"String", Symbol("deprecated")=>"Bool", Symbol("experimental")=>"Bool", Symbol("links")=>"Vector{Link}", )
OpenAPI.property_type(::Type{ UDFRuntimes }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_UDFRuntimes[name]))}

function check_required(o::UDFRuntimes)
    o.type === nothing && (return false)
    o.default === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ UDFRuntimes }, name::Symbol, val)
    if name === Symbol("description")
        OpenAPI.validate_param(name, "UDFRuntimes", :format, val, "commonmark")
    end
end
